...
int main(){
    ...
    #pragma omp parallel
    {
        ...
        long long endA   = (thread_id == num_threads - 1) ? totalA : (long long)(thread_id + 1) * sizeA;
        ...
        long long endX   = (thread_id == num_threads - 1) ? N : (long long)(thread_id + 1) * sizeX;
        ...
        long long endY   = (thread_id == num_threads - 1) ? N : (long long)(thread_id + 1) * sizeY;
    ...
    #pragma omp parallel
    {
        ...
        long long end   = (thread_id == num_threads - 1) ? N : (long long)(thread_id + 1) * rows_per_thread;
